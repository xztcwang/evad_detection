...
from dpo_builders.detectors_utils.dna_gpt import DNAGPT
...
if __name__ == '__main__':
    ...
    parser.add_argument('--detection_method', type=str, default="dna-gpt")
    ...
    parser.add_argument('--truncate_ratio', type=float, default=0.2)
    parser.add_argument('--scoring_model_name', type=str, default="gpt-neo-2.7B") #gpt-neo-2.7B, llama2-7b,mistral-46b

    parser.add_argument('--ft_reference_model_name', type=str, default="llama2-7b")  # gpt-j-6B, llama2-7b, mistral-7b
