...
import argparse
import json
from utils.metrics import  get_roc_metrics,get_precision_recall_metrics, get_bert_metrics, get_rouge_scorer, rouge_bert_scorer
...
def detect_eval(predictions,text_pairs):
    ...
    if args.use_mix:
        results_path = f"{result_file}/mixft_{args.base_model_name}_eval_mix_{args.mix_ratio}_beta_{args.dpo_beta}_ep_{args.dpo_epoch}_scoring_{args.scoring_model_name}_reference_{args.reference_model_name}.json"
    else:
        results_path = f"{result_file}/{args.base_model_name}_eval_scoring_{args.scoring_model_name}_reference_{args.reference_model_name}.json"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--detection_method', type=str, default="fast-detectgpt")
    ...
    parser.add_argument('--reference_model_name', type=str, default="gpt-j-6B")  #gpt-j-6B, llama2-13b, llama3-70b,mistral-46b
